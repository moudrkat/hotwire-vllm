...
def main() -> None:
    ...
    from hotwire import flashinfer_sampler_fallback
    why = flashinfer_sampler_fallback()   # register() does this too; say it here
    if why:
        print(f"hotwire.verify: {why}", flush=True)
